...
from Backend.Database.database_models import disease_table, feat_table, power_table, monster_table, ritual_table
...
from Discord.ui_components import QuerySelectButton
