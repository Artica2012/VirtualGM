...
async def damage_calc_resist(dmg_roll, dmg_type, target: Systems.EPF.EPF_Character.EPF_Character, weapon=None):
...
async def roll_dmg_resist(
    Character_Model: Systems.EPF.EPF_Character.EPF_Character,
    Target_Model: Systems.EPF.EPF_Character.EPF_Character,
    attack: str,
    crit: bool,
    flat_bonus="",
